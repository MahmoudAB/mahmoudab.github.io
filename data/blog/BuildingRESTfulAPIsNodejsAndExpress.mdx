...
1. We will start off by defining what is an __item__ we can put in the chest. Since we are using Mongo as our database, we will need to set up our **mongo** connection: 

    0. Make sure that your local mongodb is up and running
    1. Navigate to the main project directory and open the index.js file
    2. Start by importing body-parser (what is used to parse the data incoming from mongo to our API) and mongoose
        ```
